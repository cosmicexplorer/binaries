...
# only for osx: this is a path to an osx binary for llvm-config, which is needed
# to compile cctools. After running ./build-llvm-5.0.1.sh, llvm-config should be
